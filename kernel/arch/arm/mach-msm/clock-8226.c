...
#ifdef CONFIG_SHIRDA
	F_GCC(  12556800,      gpll0,   1,  327, 15625),	/* added for IrBlaster */
	F_GCC(  12672000,      gpll0,   1,  330, 15625),	/* added for IrBlaster */
	F_GCC(  12787200,      gpll0,   1,  333, 15625),	/* added for IrBlaster */
	F_GCC(  13824000,      gpll0,   1,  360, 15625),	/* added for IrBlaster */
	F_GCC(  14092800,      gpll0,   1,  367, 15625),	/* added for IrBlaster */
	F_GCC(  14553600,      gpll0,   1,  379, 15625),	/* added for IrBlaster */
	F_GCC(  14592000,      gpll0,   1,  380, 15625),	/* added for IrBlaster */
#endif
	F_GCC(  14745600,      gpll0,   1,  384, 15625),
#ifdef CONFIG_SHIRDA
	F_GCC(  15360000,      gpll0,   1,  400, 15625),	/* added for IrBlaster */
#endif
	F_GCC(  16000000,      gpll0,   5,    2,   15),
	F_GCC(  19200000,         xo,   1,    0,    0),
#ifdef CONFIG_SHIRDA
	F_GCC(  21504000,      gpll0,   1,  560, 15625),	/* added for IrBlaster */
	F_GCC(  21849600,      gpll0,   1,  569, 15625),	/* added for IrBlaster */
#endif
...
static struct clk_freq_tbl ftbl_camss_gp0_1_clk[] = {
	...
	F_MMSS(  27000000,      gpll0,   8,    9,    25), /* provide 600*9/(8*25)=27M clk for lcd*/
...
static struct clk_freq_tbl ftbl_camss_mclk0_1_clk[] = {
	...
	F_MMSS(  10344828,       gpll0,   1,   1, 58),
#endif /* defined(CONFIG_IMX214) */
#if defined(CONFIG_S5K8AAYX) || defined(CONFIG_S5K4H5YB)
	F_MMSS(  16000000,      gpll0,   5,    2,   15),
	F_MMSS( 17000000, mmpll0_pll,   1,   1,  47),
	F_MMSS(  17142857,      gpll0,   1,    1,   35),
...
#if defined(CONFIG_SHLCDC_BOARD)
	/* LCD external Clock */
	CLK_LOOKUP("cam_gp1_clk", camss_gp1_clk.c, "0.sharp,shdisp_kite"),
#endif
