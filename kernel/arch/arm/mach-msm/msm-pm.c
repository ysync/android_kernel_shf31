...
static bool sh_idle_powercollapse_enabled = true;
#endif
...
#ifdef CONFIG_SHSYS_CUST
void sh_set_prohibit_idle_powercollapse(bool ena)
{
	sh_idle_powercollapse_enabled = ena;
}
#endif
