...
#define machine_is_sharp_pa27() of_machine_is_compatible("qcom,sharp-pa27")
#define machine_is_sharp_kf10() of_machine_is_compatible("qcom,sharp-kf10")
...
#define machine_is_pa27()		0
#define machine_is_kf10()		0
