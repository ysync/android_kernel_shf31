...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 08-092 */
#include <linux/spinlock.h>
#endif /* CONFIG_SH_AUDIO_DRIVER *//* 08-092 */
#ifdef CONFIG_SH_AUDIO_DRIVER /* 11-100 */
#include <../../../../arch/arm/mach-msm/pm.h>
#endif /* CONFIG_SH_AUDIO_DRIVER *//* 11-100 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 11-100 */
	if ((reg == 2) && (val == 3)) {
		sh_set_prohibit_idle_powercollapse((set == 0));
		pr_debug("%s: %s(%d) power collapse\n",
			__func__, (set == 0) ? "Enable" : "Disable", (set == 0));
	}
#endif /* CONFIG_SH_AUDIO_DRIVER *//* 11-100 */
	mutex_unlock(&routing_lock);
}
